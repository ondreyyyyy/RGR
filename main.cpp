...
int main() {
    ...
    if (aesLib) {
        ...
        if (!aesEncryptFile || !aesDecryptFile || !aesEncryptText) {
    ...
    if (chachaLib) {
        ...
        if (!chachaEncryptFile || !chachaDecryptFile || !chachaEncryptText) {
    ...
    if (rabbitLib) {
        ...
        if (!rabbitEncryptFile || !rabbitDecryptFile || !rabbitEncryptText) {
